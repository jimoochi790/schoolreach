...
export const metadata: Metadata = {
  ...
  description:
    "Enter your child's Year 5 NAPLAN bands to estimate which NSW Selective High Schools are within reach. Free selective school calculator with detailed guide covering all 48 schools with community-reported cutoffs.",
  keywords: [
    "NAPLAN selective estimator",
    "Selective High School calculator",
    "Year 5 NAPLAN",
    "selective school placement score",
    "NAPLAN band to selective score",
    "NSW selective schools",
    "Year 7 entry",
    "selective school cutoff scores 2025",
  ],
};
